...
| Temporary avoid (timed) | ❌ | ❌ | ❌ | ❌ | ✅ | ❌ → **P1** |
| Priority talkgroups (preempt) | ✅ 1–99 | ✅ rank | ✅ | ✅ | ✅ | ❌ → **P1** |
| Hold on talkgroup / site | ❌ | ✅ | ✅ | ✅ | ✅ | ❌ → **P1** |
| Skip current call | ❌ | — | — | ✅ | ✅ | ❌ → **P1** |
| Delay / hang time | fade timers | ✅ | — | 2 s | ✅ | 🟡 fixed → **P1** expose |
...
| Auto-start on launch | ✅ | — | — | service | ✅ | ❌ → **P1** |
...
| Metadata sidecar (JSON) | ❌ | SRT | ✅ | ID3 tags | ❌ → **P1** |
| Filename formatter | fixed | aliases | fixed | ✅ | 🟡 fixed → P2 |
| Instant replay / replay last | ❌ | ❌ | — | grid | 🟡 per-row → **P1** "replay last" |
| Priority preemption of audio | ✅ | ✅ | — | — | ❌ → **P1** |
| Mute / volume | ✅ | ✅ | — | ✅ | 🟡 play on/off → P2 volume |
| Start/drop tones, alert tones | ✅ | ✅ | — | — | ❌ → **P1** |
...
| Decoder-state panel (NAC, WACN, site, neighbours, bandplan) | ✅ | ✅ | — | 🟡 NAC/mod → **P1** |
| Event log (moves, affiliations, patches, denials) | ✅ | ✅ | — | 🟡 one-line notice → **P1** |
| Emergency indication + alert | ✅ | ✅ | LED | ❌ → **P1** |
| Per-TG alert sound / LED color | actions | — | ✅ | ❌ → **P1** (sound) |
...
|---|:-:|:-:|:-:|:-:|
| Call event CSV log | ✅ | JSON | SQL | ❌ → **P1** |
