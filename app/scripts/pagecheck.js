...
w.__exercise = async () => {
  ...
  for (const v of ["library", "playlists", "aliases", "discovery", "alerts", "analyzers", "dispatch", "devices", "settings", "monitor"]) { try { w.showView(v); } catch (e) { console.log("PAGE ERROR: view " + v + ": " + e.stack); } }
