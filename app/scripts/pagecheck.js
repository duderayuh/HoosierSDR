...
const lockouts = [];
const mutes = [];
const CALL7 = { id: 7, start: 100, secs: 5.6, tg: 10202, tg_name: "Dispatch", unit: 790044, unit_name: "Console", freq_hz: 851000000, modulation: "p25", emergency: false, patched_with: [], system: "Test", site: "1", audio: null, sha256: null, transcript: "I", transcript_model: "whisper", transcript_edited: null, starred: false, service: "", category: "", encrypted: false, poor_frames: 3, marginal_frames: 2, ruined_frames: 1, dropped_blocks: 0, level_dbfs: -42.5, echo_frac: 0.074, echo_spread_us: 46, fired: [] };
