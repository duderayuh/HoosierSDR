...
/* ---------- views ---------- */
const VIEWS = ["monitor", "library", "tripwires", "conversations", "cases", "research", "dispatch", "dashboard", "settings"];
function showView(v) {
  ...
  if (v === "research" && typeof window.researchOnShow === "function") window.researchOnShow();
