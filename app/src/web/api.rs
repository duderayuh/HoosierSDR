...
pub async fn dispatch(app: &AppHandle, cmd: &str, args: &Value) -> Result<Value, String> {
    ...
    match cmd {
        ...
        "tripwires_set" => jv(crate::tripwires::tripwires_set(app.clone(), state, arg(args, "tripwires")?, arg(args, "folders")?)?),
        ...
        "email_get" => jv(crate::email::email_get()),
        "email_set" => jv(crate::email::email_set(arg(args, "settings")?)?),
        "email_save_password" => jv(crate::email::email_save_password(arg(args, "password")?)?),
        "email_test" => jv(crate::email::email_test(arg(args, "to")?).await?),
        ...
        "cases_list" => jv(crate::cases::cases_list(app.clone(), state, arg(args, "hours")?)?),
        "cases_rebuild" => jv(crate::cases::cases_rebuild(app.clone(), arg(args, "days")?).await?),
        "cases_profiles" => jv(crate::cases::cases_profiles(app.clone())),
        "cases_set_telegram" => jv(crate::cases::cases_set_telegram(app.clone(), arg(args, "profile")?, arg(args, "telegram")?)?),
        "cases_preview" => jv(crate::cases::cases_preview(app.clone(), arg(args, "profile")?, arg(args, "days")?).await?),
        "research_stats" => jv(crate::research::research_stats(app.clone(), arg(args, "days")?).await?),
        "research_set_record" => jv(crate::research::research_set_record(state, arg(args, "profile")?, arg(args, "incident")?, arg(args, "phone_at")?, arg(args, "ed_arrived_at")?, arg(args, "note")?)?),
        "research_export" => jv(crate::research::research_export(arg(args, "rows")?)?),
        "research_summary" => jv(crate::research::research_summary(arg(args, "groups")?)),
        "study_packet" => jv(crate::study::study_packet(state, arg(args, "rows")?)?),
        "study_import" => jv(crate::study::study_import(state, arg(args, "text")?)?),
        "study_compare" => jv(crate::study::study_compare(state, arg(args, "rows")?)?),
        "radios_backfill" => jv(crate::radios::radios_backfill(app.clone()).await?),
        "radios_list" => jv(crate::radios::radios_list(state)?),
        "radio_identity" => jv(crate::radios::radio_identity(state, arg(args, "system")?, arg(args, "radio")?)?),
        "radio_evidence" => jv(crate::radios::radio_evidence(state, arg(args, "system")?, arg(args, "radio")?)?),
        "radio_confirm" => jv(crate::radios::radio_confirm(app.clone(), state, arg(args, "system")?, arg(args, "radio")?, arg(args, "role")?, arg(args, "callsign")?)?),
        "radio_reject" => jv(crate::radios::radio_reject(app.clone(), state, arg(args, "system")?, arg(args, "radio")?, arg(args, "callsign")?)?),
        "radio_for_call" => jv(crate::radios::radio_for_call(state, arg(args, "call")?)?),
        "radio_answer_call" => jv(crate::radios::radio_answer_call(app.clone(), state, arg(args, "call")?, arg(args, "answer")?)?),
        "radio_answer" => jv(crate::radios::radio_answer(app.clone(), state, arg(args, "system")?, arg(args, "radio")?, arg(args, "answer")?)?),
        "radio_unconfirm" => jv(crate::radios::radio_unconfirm(app.clone(), state, arg(args, "system")?, arg(args, "radio")?)?),
        ...
        "dashboards_get" => jv(crate::dashboards::dashboards_get(state)),
        "dashboards_render" => jv(crate::dashboards::dashboards_render(state, arg(args, "id")?)?),
        "dashboards_set" => jv(crate::dashboards::dashboards_set(app.clone(), state, arg(args, "settings")?)?),
        "rx_health" => jv(crate::rxhealth::rx_health(state, arg(args, "hours")?)?),
        "pathways_get" => jv(crate::pathways::pathways_get(state)),
        "pathways_set" => jv(crate::pathways::pathways_set(app.clone(), state, arg(args, "settings")?)?),
        "pathways_reset" => jv(crate::pathways::pathways_reset(app.clone(), state)?),
        "incident_route" => jv(crate::pathways::incident_route(
            state,
            arg(args, "id")?,
            arg(args, "which")?,
        )?),
        "pathways_preview" => jv(crate::pathways::pathways_preview(state, arg(args, "settings")?)?),
